...
func ValidateFilters(v *validator.Validator,f Filters) {
	// chaeck that the page and page_size parameters contain sensible values
...
// that the last page value is calculated using the math.Ceil() function, which rounds // up a float to the nearest integer. So, for example, if there were 12 records in total
